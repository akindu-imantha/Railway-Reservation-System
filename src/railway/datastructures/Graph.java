...
// Represents railway stations and the distances between directly connected stations.
// The matrix stores 0 when no direct route exists between two stations.
public class Graph {
    ...
    public void addEdge(String source, String destination, int distance) {
        ...
        // Routes work both ways, so store the same distance in both directions.
    ...
    public void bfs(String start) {
        ...
        // visited prevents the same station from being printed more than once.
    ...
    public void dfs(String start) {
        ...
        // DFS also uses visited to avoid travelling in circles.
        boolean[] visited = new boolean[stations.length];
    ...
    public void shortestPath(String source, String destination) {
        ...
        // Dijkstra's algorithm records the best known distance and previous station.
        ...
        for (int count = 0; count < stations.length - 1; count++) {
            // Select the unvisited station that is currently closest to the source.
            ...
            for (int i = 0; i < stations.length; i++) {
                if (!visited[i] && adjacencyMatrix[current][i] > 0
                    ...
                    // A shorter route was found through the current station.
        ...
        // Follow previous links backwards, adding each station to the front of the path.
        while (current != -1) {
