...
// Stores reservations in insertion order using linked nodes.
// Unlike an array, it can grow without choosing a fixed maximum size.
public class LinkedList {
    ...
    public void insert(Reservation reservation) {
        // New reservations are added at the end to preserve booking order.
    ...
    public boolean delete(int reservationId) {
        if (head == null)
            return false;
        // Head needs separate handling because it has no previous node.
    ...
    public Reservation[] toArray() {
        // Arrays are needed by the sorting methods in the Sort class.
    ...
    public boolean isSeatBooked(int trainNo, int seatNo) {
        ...
        while (current != null) {
            ...
            // A seat is unique only inside the same train.
